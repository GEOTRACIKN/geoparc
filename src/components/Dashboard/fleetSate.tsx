    ...
    series: [
      {
        ...
        borderRadius: 5,
        data: [
          { name: 'Driving', y: options.DrivingValue, z: 100 },
          { name: 'Parcking', y: options.ParckingValue, z: 100 },
          { name: 'Stop with engine start', y: options.ParkingEngineRunningValue, z: 100 },
